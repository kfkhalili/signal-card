...
// ❌ BAD: Accessing wrong properties (card has companyName, not company_name)
if (profileCard) {
  profileContext = {
...
1. Some cards create custom error classes ✅
2. Some cards return generic Error ❌
3. Some cards log warnings, some don't ❌
4. Some cards show toasts, some don't ❌
5. Error messages are inconsistent ❌
...
1. ✅ Create `profileExtractionService.ts` - **~400 lines saved**
2. ✅ Refactor all card initializers to use centralized profile extraction
3. ✅ Fix type inconsistencies

### Phase 2: Construction Patterns
4. ✅ Create `cardConstructionService.ts` - **~150 lines saved**
5. ✅ Create `cardDescriptionService.ts` - **~100 lines saved**
6. ✅ Standardize card construction across all cards

### Phase 3: Error Handling
7. ✅ Create `CardInitializationError` class
8. ✅ Standardize error handling wrapper
9. ✅ Update all initializers to use standardized errors

### Phase 4: Architecture Improvements
10. ✅ Create `BaseCardInitializer` abstract class
11. ✅ Refactor cards to extend base class
12. ✅ Improve update handler type safety

### Phase 5: Polish & Optimization
13. ✅ Extract constants and enums
14. ✅ Add comprehensive unit tests
15. ✅ Refactor large functions into smaller units
