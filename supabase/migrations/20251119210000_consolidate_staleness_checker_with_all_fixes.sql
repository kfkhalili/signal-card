-- Consolidate all fixes for check_and_queue_stale_data_from_presence_v2
...
-- - 20251118030000_fix_background_staleness_checker_for_missing_data.sql (keeps LEFT JOIN, but adds back timeout and exchange check)
-- - 20251119000000_fix_exchange_status_check_for_missing_quote_data.sql (keeps all fixes, but adds timeout)
