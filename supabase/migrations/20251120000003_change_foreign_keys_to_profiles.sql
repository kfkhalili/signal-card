...
-- 6. exchange_variants (uses symbol, renamed from base_symbol)
...
COMMENT ON CONSTRAINT "fk_exchange_variants_symbol" ON "public"."exchange_variants" IS 'References profiles.symbol. Column renamed from base_symbol to symbol for consistency.';
