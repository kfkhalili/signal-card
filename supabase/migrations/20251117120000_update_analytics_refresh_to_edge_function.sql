-- Update analytics refresh to use Edge Function instead of placeholder database function
-- CRITICAL: Edge Function queries Realtime Presence and updates active_subscriptions_v2
-- This keeps last_seen_at accurate based on actual Presence state

-- Update the database function to call the Edge Function
